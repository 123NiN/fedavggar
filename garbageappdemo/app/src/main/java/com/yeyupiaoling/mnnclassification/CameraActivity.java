...
public class CameraActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // 加载模型和标签
        classNames = Utils.ReadListFromFile(getAssets(), "list.txt");
        String classificationModelPath = getCacheDir().getAbsolutePath() + File.separator + "mobilenet_gar.mnn";
        Utils.copyFileFromAsset(CameraActivity.this, "mobilenet_gar.mnn", classificationModelPath);
        try {
