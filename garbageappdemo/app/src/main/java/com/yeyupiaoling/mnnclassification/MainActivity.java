...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String classificationModelPath = getCacheDir().getAbsolutePath() + File.separator + "model_gar.mnn";
        Utils.copyFileFromAsset(MainActivity.this, "model_gar.mnn", classificationModelPath);
        try {
